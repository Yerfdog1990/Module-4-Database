...
public class HibernateUtil {
  ...
  private static Class<?>[] getEntities() {
    return new Class<?>[] {DenormalizedEmployee.class, Citizenship.class, Profession.class, Department.class, Employee.class};
  }

  private static DataSource createDataSource() {
    JdbcDataSource dataSource = new JdbcDataSource();
    dataSource.setURL("jdbc:h2:mem:hibernate-orm-demo;DB_CLOSE_DELAY=-1;");
    return ProxyDataSourceBuilder.create(dataSource).name("H2 DataSource").countQuery().build();
  }
  ...
  private static SessionFactory createDataSourceProxySessionFactory() {
    ...
    metadataSources.addAnnotatedClasses(DenormalizedEmployee.class, Citizenship.class, Profession.class, Department.class, Employee.class);
